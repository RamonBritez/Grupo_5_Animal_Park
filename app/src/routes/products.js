...
router.post('/', isAdmin, upload.uploadImageProduct.array('image'), productValidator, store); 
...
router.put('/update/:id', isAdmin, upload.uploadImageProduct.array('image'), productValidator, update); 
